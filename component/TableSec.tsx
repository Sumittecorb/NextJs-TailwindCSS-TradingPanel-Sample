            ...
            <section className="grid md:grid-cols-3 xl:grid-cols-3 gap-6">
                <div className="flex items-center px-4 py-2 bg-subMain shadow  border-subMain border rounded-lg">
                    <div className=" mr-4 w-32">
                        <span className="block text-sm text-white">AVG RETURNS</span>
                ...
                <div className="overflow-y-auto" style={{ maxHeight: '50rem' }}>
                    <table className="table-auto rounded-lg mx-auto  w-full">
                        <thead className=" items-center bg-subMain shadow  border-subMain border rounded-lg">
                            <tr>
                                <th></th>
                                <th className="px-6 py-3 text-center text-sm font-medium text-white">RESULT</th>
                                <th className="px-6 py-3 text-center text-sm font-medium text-white">DATE</th>
                                <th className="px-6 py-3 text-center text-sm font-medium text-white">RESULT</th>
                                <th className="px-6 py-3 text-center text-sm font-medium text-white">RATE</th>
                                <th className="px-6 py-3 text-center text-sm font-medium text-white">RESULT</th>
                                <th className="px-6 py-3 text-center text-sm font-medium text-white">RESULT</th>
                                <th className="px-6 py-3 text-center text-sm font-medium text-white">RESULT</th>
                                <th className="px-6 py-3 text-center text-sm font-medium text-white">RETURN</th>
                                <th className="px-6 py-3 text-center text-sm font-medium text-white">RESULT</th>
                                <th className="px-6 py-3 text-center text-sm font-medium text-white">RESULT</th>
                                <th className="px-6 py-3 text-center text-sm font-medium text-white"></th>
                                <th className="px-6 py-3 text-center text-sm font-medium text-white">RESULT</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr className="bg-Stone text-white hover:bg-gray-600">
                                <td className="px-6 border-gray-600  py-3 text-center text-sm font-medium text-Red">
                                ...
                                <td className="px-6 py-3 text-center text-sm font-medium text-Red">
                                    <span className="bg-green text-white px-2 py-1">Win</span>
                                </td>
                                <td className="px-6 py-3 text-center text-sm font-medium text-Red">
                                    SEPT 7,2019</td>
                                <td className="px-6 py-3 text-center text-sm font-medium text-blue">
                                    ANY</td>
                                <td className="px-6  py-3 text-center text-sm font-medium text-Lime">
                                    $2.3</td>
                                <td className="px-6  py-3 text-center text-sm font-medium text-Lime">
                                    $5.3</td>
                                <td className="px-6 py-3 text-center text-sm font-medium text-Red">
                                ...
                                <td className="px-6 py-3 text-center text-sm font-medium text-win">
                                    5,373</td>
                                <td className="px-6  py-3 text-center text-sm font-medium text-win">
                                    26%</td>
                                <td className="px-2 md:px-0 py-3 text-center text-sm font-medium text-Red">
                                    <span className="bg-progressBar text-white md:px-0 px-2 py-1">Earning winner</span>
                                </td>
                                <td className="px-6 py-3 text-center text-sm font-medium text-progressText">
                                    1+More</td>
                                <td className="px-6 py-3 text-center text-sm font-medium text-Red">
                            ...
                            <tr className="bg-Stone text-white hover:bg-gray-600">
                                ...
                                <td className="px-6  py-3 text-center text-sm font-medium text-win">
                                    26%</td>
                                <td className="md:px-0 px-2 py-3 text-center text-sm font-medium text-Red">
