        ...
        <div className="grid grid-cols-3 gap-4 ">
            <div className="col-span-2 ">
                <div className="flex items-center px-0  mt-2 shadow  flex-wrap">
                    <button className="flex px-1 py-1 text-win text-normaltext mb-2  ml-1 mr-1">
                        <span className="flex-inline">Report</span> </button>
                    <button className="flex border-gray-500 border px-1 py-1 text-white text-normaltext rounded  mb-2 mr-1">
                    ...
                    <button className="flex px-1 py-1 text-white text-normaltext rounded  mb-2 mr-1">
                        <span className="flex-inline">CLEAR FILTER</span> </button>
                </div>
            </div>
            <div className="col-span-1 ">
                <div className="flex items-center px-0 py-2 shadow justify-end ">
                    <button className="flex border-win border px-1 py-1 text-white text-normaltext bg-win  mr-1">
